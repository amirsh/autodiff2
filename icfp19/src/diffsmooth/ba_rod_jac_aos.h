...
array_array_array_number_t ba_proj_jac2(array_number_t cam, array_number_t xs, index_t n) {
  ...
  array_array_array_number_t x4218 = (array_array_array_number_t)storage_alloc(sizeof(int) * 2);x4218->length=x3857;x4218->arr = (array_array_number_t*)storage_alloc(sizeof(array_array_number_t) * x3857);
  for(int i = 0; i < x4218->length; i++){
    ...
    array_array_number_t x4217 = (array_array_number_t)storage_alloc(sizeof(int) * 2);x4217->length=n;x4217->arr = (array_number_t*)storage_alloc(sizeof(array_number_t) * n);
    for(int i0 = 0; i0 < x4217->length; i0++){
      ...
      array_number_t x4216 = (array_number_t)storage_alloc(sizeof(int) * 2);x4216->length=2;x4216->arr = (number_t*)storage_alloc(sizeof(number_t) * 2);
